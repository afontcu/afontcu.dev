...
But then I think about it differently. The job was never really "writing code". It was figuring out what to build, spotting problems, making tradeoffs, aligning people. It was never so obvious: [code is just the cost of getting to business impact](https://afontcu.dev/goal-of-software-development/). The AI just handles the translation now.
...
If you're on the **building** side: double down. You know the drill already. [Talk to users](https://afontcu.dev/ways-telling-problem-oriented/). Prioritize. Plan. Architect. Ship.
...
There are still "coding things" that are extremely useful nowadays. AI tooling is WAY more useful with good Continuous Integration practices, a good safety net made of tests and types and checks. [Feedback loops](https://afontcu.dev/feedback-loops/) are more important than ever.

Either way: focus on fundamentals. [Simplicity](https://afontcu.dev/small-increment/). [Outcomes over outputs](https://afontcu.dev/ways-telling-problem-oriented/). The AI is **terrible at these**. You can be great at them.
