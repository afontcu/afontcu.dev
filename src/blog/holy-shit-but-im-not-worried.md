---
title: "Holy shit (but I'm not worried)"
description: "AI doesn't change what great software development is about. It reveals it."
date: '2026-01-07T10:00:00.000Z'
tags: ['Software Crafting', 'Random Thoughts']
slug: holy-shit-but-im-not-worried
---
...
Think about it. [The goal of software development](https://afontcu.dev/goal-of-software-development/) was never writing code. [Code is a liability](https://afontcu.dev/shoe-factory-build-software/), not an asset. [Simplicity is essential](https://afontcu.dev/back-to-basics/) and hard. It's about [feedback loops](https://afontcu.dev/feedback-loops/), not typing speed. Even [Claude Code's own creators](https://x.com/anthropics) admit that the best way to use AI is to give it a way to check that everything works: tests, feedback loops.
...
[Someone on Reddit](https://www.reddit.com/r/ClaudeCode/comments/1q5lupd/developer_uses_claude_code_and_has_an_existential/) put it perfectly: "90% of my skills are now useless but the other 10% are now 10000x more valuable."
...
But the fundamentals (simplicity, feedback loops, outcomes over outputs, [small increments](https://afontcu.dev/small-increment/)) seem more true than ever. Not less.
