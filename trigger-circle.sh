...
if [ "$PULL_REQUEST" = true ]; then
  ...
  curl -u ${CIRCLE_API_USER_TOKEN}: \
        ...
        https://circleci.com/api/v1.1/project/github/afontcu/afontcu.dev/tree/pull/$REVIEW_ID
else
  curl -u ${CIRCLE_API_USER_TOKEN}: \
        -d build_parameters[CYPRESS_baseUrl]=$DEPLOY_URL \
        https://circleci.com/api/v1.1/project/github/afontcu/afontcu.dev/tree/$BRANCH
fi